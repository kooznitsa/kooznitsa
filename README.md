...
- Driven and self-motivated backend developer with 1 year professional experience in web development. 
- Proficient in Python programming language and related frameworks such as Django and Django Rest Framework.
...
| Course                                                                                                                                        | Timeframe         |
| ----------------------------------------------------------------------------------------------------------------------------------------------| ----------------- |
| [otus.ru / Symfony Framework](https://otus.ru/lessons/symfony/)                                                                               | 10/2024 – 12/2024 |
